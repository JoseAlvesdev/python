...
Herança Múltipla nada mais é do que a possibilidade de uma classe 
herdar de múltiplas classes, fazendo com que a classe filha herde todos
...
# Observe que a classe MultiDerivada e derivada da classe Base3, e que a 
# classe Base3 deriva da Base2 e a Base 2 deriva da Base1. Portanto a 
# classe MultiDerivada está herdando as classes Base1 e Base2
# indiretamente, e a classe Base3 diretamente

# OBS.: Não importa se a derivação é direta ou indireta. A classe que 
realizar a herança herdará todos os atributos e métodos das super classes.
"""
